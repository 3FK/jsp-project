...
public class Customer {
	...
	public Customer(int customerID, String customerName, String country, String NICPassport, int contactNo) {
		this(customerName, country, NICPassport, contactNo);
		this.customerID = customerID;
	}
	public Customer(String customerName, String country, String NICPassport, int contactNo) {
