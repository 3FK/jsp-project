...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<div class="h2 text-info" style="margin-top:20px;margin-bottom:20px;" align="center">Customers</div>
		...
		<div class="container ">
			...
			<c:forEach items="${customerList}" var="customerList">
				<div class="row" style="border: 1px solid #4834d4;">
					...
					<div class="col-sm ">
						<a class="" href="/HotelManagement/editBill?id=<c:out value='${customerList.customerID}' />">Edit Bill</a>
					</div>
				</div>
			</c:forEach>
		</div>
